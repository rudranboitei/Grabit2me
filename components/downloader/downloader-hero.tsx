...
export function DownloaderHero() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center mb-10 md:mb-24 mt-6 md:mt-16 relative z-10 px-2">
      
      {/* Small top title */}
      <div className="text-[12px] md:text-[16px] font-[500] tracking-tight text-[#1b1c1c] flex items-center justify-center gap-2 mb-4 md:mb-6 opacity-80">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 md:w-5 md:h-5"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        <span>Fast & Free Downloader</span>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 md:w-5 md:h-5"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
      </div>

      {/* Main massive headline as requested */}
      <h1 className="text-[42px] sm:text-[64px] md:text-[84px] font-[730] tracking-[-0.04em] text-[#1b1c1c] leading-[1.05] max-w-[900px] text-center mx-auto mb-4 md:mb-6">
        Need to save reels? <br className="hidden md:block"/> I&apos;ve got you covered
      </h1>
